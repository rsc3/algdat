...
% This code was modified to for the Iris data to have three colors
...
ck = find( classEM == 1);
plot(x(1, ck), x(2, ck), 'd','Color',colors(1,:))
ck = find( classEM == 2);
plot(x(1, ck), x(2, ck), 'o','Color',colors(2,:))
ck = find( classEM == 3);
plot(x(1, ck), x(2, ck), 'x','Color',colors(3,:))
iterEM = sprintf('%d', numberOfIterations);
